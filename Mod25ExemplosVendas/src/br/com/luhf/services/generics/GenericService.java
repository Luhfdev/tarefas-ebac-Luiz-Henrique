...
import br.com.luhf.anotacao.TipoChave;
import br.com.luhf.dao.generics.IGenericDao;
import br.com.luhf.dao.generics.SingletonMap;
...
public abstract class GenericService<T extends Persistente> implements IGenericSerices<T> {
